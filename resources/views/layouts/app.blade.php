...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand fw-bold fst-italic fs-3 text-danger vr" href="{{ url('/home') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                            <li class="navbar-brand mr-5">
                                <a class="btn btn-outline-info fw-bold" style="margin-right: 950px"
                                    href="{{ url('/index') }}">
                                    {{ 'Home' }}
                                </a>
                            </li>
